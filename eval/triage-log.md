...
| Gap-scan entries | 18 |
| Re-audit / re-pin entries | 13 |

The last three rows **overlap** the partition above and are not added to it: the nineteen bulk-reject classes are T-029…T-037, T-070…T-072 and T-151, T-152, T-154 plus the T-150 and T-240 scoping records and T-241, T-242 from pass 3, thirteen of which also carry an `HR-N` or `axis:` trigger; the thirteen re-audit entries are T-026…T-028 (the 2026-08-18 G5 rehearsal), T-064…T-069 (the 2026-08-22 review corrections), T-149 (the B-6 agent-ownership recalibration), T-273 (the resolvable-citation and trigger-coherence sweep) and T-274, T-275 (the Phase-5 re-examination of the two knowingly-contested shortlist rows). The words "sixteen", "sixteen" and "ten" that stood in this sentence until 2026-08-25 were stale against the table and are corrected at T-276. **Gap-scan entries move off 0 for the first time**: T-221…T-238 disposition all 157 rows of `hesreallyhim/awesome-claude-code`'s catalog across its 18 categories — 9 mapped to an owning plugin, 9 explicitly out of scope, zero merge candidates sourced from it (V4.4).
