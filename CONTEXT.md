...
**Purpose of this file:** orient a new session or contributor in under five minutes. This file is **descriptive**; `SPEC.md` v2.9 is normative and wins every conflict. Nothing here restates a spec rule — rules are referenced by ID (D-16).
...
- **Spec:** v2.9 governing (`SPEC.md`), dated 2026-08-25. It ships verbatim at repository root and is never regenerated (D-16).
...
5. `DECISIONS.md` — ADR-001…ADR-026 when rationale or enforcement detail is needed.
