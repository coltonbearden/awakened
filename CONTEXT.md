...
**Purpose of this file:** orient a new session or contributor in under five minutes. This file is **descriptive**; `SPEC.md` v2.10 is normative and wins every conflict. Nothing here restates a spec rule — rules are referenced by ID (D-16).
...
- **Spec:** v2.10 governing (`SPEC.md`), dated 2026-08-26. It ships verbatim at repository root and is never regenerated (D-16).
