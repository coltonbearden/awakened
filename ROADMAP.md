...
- `aura` preset expansion beyond the §5 tables — original work, same review path. **Decided 2026-09-02:** not scheduled; it opens when a user-filed issue asks for a preset, and then under N-5 with no exceptions (D-28).
