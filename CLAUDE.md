...
**Governing document:** `SPEC.md` v2.9. On any conflict between this file and `SPEC.md`, `SPEC.md` wins and this file is corrected in the same commit.
...
1. `SPEC.md` — normative specification (v2.9)
